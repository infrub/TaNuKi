...
def epm0241():
    def ikuze(b,chi,seed):
        ...
        kasokus = [1.6,1.65,1.7,1.75,1.8,1.85,1.9,1.95]
        #kasokus = [0.8,1.0,1.6,1.65,1.7,1.75,1.8,1.85,1.9,1.95]
        for i,kasoku in enumerate(kasokus):
            try:
                yaru("alg08", {"kasoku":kasoku}, cm.gist_ncar((i+1)/(len(kasokus)+1)))
            except Exception as e:
        ...
        kasoku_universe = [1.6,1.65,1.7,1.75,1.8,1.85,1.90,1.94]
        #kasoku_universe = [1.0,1.6,1.65,1.7,1.72,1.74,1.76,1.78,1.8,1.85,1.94,1.95]
        try:
            yaru("alg21", {"kasokus":kasoku_universe}, "black")
        except Exception as e:
            print(e)
...
def epm0242():
    def ikuze(b,chi,seed):
        ...
        #kasokus = [1.6,1.65,1.7,1.75,1.8,1.85,1.9,1.95]
        kasokus = [0.8,1.0,1.2,1.4,1.6,1.65,1.7,1.75,1.8,1.85,1.9,1.95]
        for i,kasoku in enumerate(kasokus):
            try:
                yaru("alg08", {"kasoku":kasoku}, cm.gist_ncar((i+1)/(len(kasokus)+1)))
            except Exception as e:
        ...
        #kasoku_universe = [1.6,1.65,1.7,1.75,1.8,1.85,1.90,1.94]
        kasoku_universe = [1.6,1.65,1.7,1.72,1.74,1.76,1.78,1.8,1.85,1.94,1.95]
        try:
            yaru("alg21", {"kasokus":kasoku_universe}, "black")
        except Exception as e:
            print(e)
        ...
        ax2.set_xlim(0,min(100,ax2.get_xlim()[1]))
        plt.legend()
        plt.suptitle(f"epm0243[b={b},chi={chi},seed={seed}]")
        plt.savefig(f"epm0243_oups/[b={b}, chi={chi}, seed={seed}].png", dpi=400)
        #plt.show()
