...
def epm0230():
    ...
    memo = {}
    M,S,N = ENV.optimal_truncate_alg02(A, maxiter=10, chi=chi, memo=memo)
    print(memo)
    print(M*S*N)
...
def epm0231():
    ...
    memo = {}
    M,S,N = ENV.optimal_truncate_alg01(A, maxiter=1000, chi=chi, memo=memo)
    print(memo)
    print(M*S*N)

    memo = {}
    M,S,N = ENV.optimal_truncate_alg03(A, maxiter=1000, chi=chi, memo=memo)
    print(memo)
    print(M*S*N)
